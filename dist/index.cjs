...
var isFormData2 = (value) => {
  return value instanceof import_form_data2.default;
};
...
var sendRequest = async (config, options, url2, body, formData, headers, onCancel, axiosClient) => {
...
var request = (config, options, axiosClient = axios_default) => {
  return new CancelablePromise(async (resolve2, reject, onCancel) => {
    try {
      ...
      if (!onCancel.isCancelled) {
        const response = await sendRequest(config, options, url2, body, formData, headers, onCancel, axiosClient);
...
var ProgramSize = /* @__PURE__ */ ((ProgramSize2) => {
  ...
  ProgramSize2["MEDIUM"] = "Medium";
  ProgramSize2["LARGE"] = "Large";
  ProgramSize2["EXTRA_LARGE"] = "ExtraLarge";
  return ProgramSize2;
})(ProgramSize || {});
